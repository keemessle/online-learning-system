...
public class BoardController extends HttpServlet {
	...
	public void requestBoardList(HttpServletRequest request) {
		...
		boardlist = dao.getBoardList(boardID, pageNum, limit, items, text);
		
		int total_record = dao.getListCount(items, text, boardID);
   ...
   //새로운 글 등록하기
	public void requestBoardWrite(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		// Retrieve and set boardID
	    int boardID = Integer.parseInt(request.getParameter("boardID"));
	    board.setBoardID(boardID);
	    
	    // Insert the board entry
	    dao.insertBoard(board);

	    // Redirect to the board list page
	    response.sendRedirect("BoardListAction.do?boardID=" + boardID);
	...
	public void requestBoardUpdate(HttpServletRequest request) {
		...
		// java.time 패키지를 사용하여 현재 날짜와 시간 포맷팅
