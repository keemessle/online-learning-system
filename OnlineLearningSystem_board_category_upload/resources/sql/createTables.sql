...
CREATE TABLE Students (
    ...
    login_id VARCHAR(50) UNIQUE NOT NULL, /* 학생 로그인 아이디 */
...
CREATE TABLE Professors (
	...
	login_id VARCHAR(50) UNIQUE NOT NULL, /* 교수 로그인 아이디 */
...
ALTER TABLE board ADD COLUMN boardID int;
ALTER TABLE board modify column boardID int after num;